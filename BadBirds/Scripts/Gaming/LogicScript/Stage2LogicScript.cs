...
public class Stage2LogicScript : MonoBehaviour
{
    ...
    public bool level5AlreadyPassed = false;
    ...
    public Vector3 birdToBeThrownPos = new Vector3(-4.867f, -1.756f, 0f);
    public Vector3 goodBirdPos1 = new Vector3(-5.780f, -3.447f, 0f);
    public Vector3 goodBirdPos2 = new Vector3(-6.346f, -3.447f, 0f);
    public Vector3 goodBirdPos3 = new Vector3(-6.912f, -3.447f, 0f);
    public Vector3 goodBirdPos4 = new Vector3(-7.478f, -3.447f, 0f);
    public Vector3 goodBirdPos5 = new Vector3(-8.044f, -3.447f, 0f);
    public Vector3 goodBirdPos6 = new Vector3(-8.610f, -3.447f, 0f);
    public Vector3 goodBirdPos7 = new Vector3(-9.3f, -3.447f, 0f);
    
    public Vector3[] goodBirdPositions = new Vector3[8];
    ...
    void Start()
    {
        ...
        if (goodBirds.Length > 7)
        {
            goodBirdsAreInPositions = new bool[7];
        }
        else
        {
        ...
        goodBirdPositions[7] = goodBirdPos7;
    ...
    void updateLevelDatas()
    {
        if (File.Exists(LEVELDATAPATH))
        {
            ...
            else if (levelCount == "5" && !level5AlreadyPassed)
            {
                string level = (int.Parse(levelCount) + 1).ToString();
    ...
    void getBirdsToPositions()
    {
        for (int i=0 ; i<goodBirds.Length ; i++)
        {
            if (i >= 7)
            {
                goodBirds[i].transform.position = goodBirdPos7;
            }
            else
            {
